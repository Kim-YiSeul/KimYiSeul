...
function fn_search()
{
	...
	document.searchForm.action = "/help/list";
...
<%@ include file="/WEB-INF/views/include/admin_gnb.jsp" %>
	<div id="school_list" style="width:90%; margin:auto; margin-top:5rem;">
		<div class="mnb" style="display:flex; margin-bottom:0.8rem;">
			<h2 style="margin-right:auto; color: #525252;">공지사항 리스트</h2>
		...
		<div class="school_list_excel">
			<table class="table table-hover" style="border:1px solid #c4c2c2;">
				...
				<c:forEach items="${helpList}" var="board" varStatus="status">
				<tr>
				    <td>${board.rNum}</td>
	                <td>
	                ...
	                <th><a href="/help/update?bbsSeq=${board.bbsSeq}" name="helpUpdate">${board.bbsTitle}</a></th>
				...
				<c:if test="${empty helpList}">
				<tr>
				    <td colspan="7">등록된 공지사항 게시판 정보가 없습니다.</td>
				</tr>	
				</c:if>
				</tbody>
			</table>
