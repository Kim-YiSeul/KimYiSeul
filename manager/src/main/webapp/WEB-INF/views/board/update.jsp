...
<div class="layerpopup" style="width:1123px; margin:auto; margin-top:5%;">
	<h1 style="font-size: 1.6rem; margin-top: 3rem; margin-bottom: 1.6rem; padding: .5rem 0 .5rem 1rem; background-color: #e0e4fe;">게시물 수정</h1>
	<div class="layer-cont">
			...
			<table>
				<tbody>
					...
					<tr>
						...
						<td>
							<fmt:formatNumber type="number" maxFractionDigits="3" value="${board.bbsLikeCnt}"/>
							<input type="hidden" id="bbsLikeCnt" name="bbsLikeCnt" value="${board.bbsLikeCnt}" />
						</td>
					</tr>
		...
		<div class="pop-btn-area" style="float: right;">
			<button onclick="fn_boardUpdate()" class="btn-type01"><span>수정</span></button>
